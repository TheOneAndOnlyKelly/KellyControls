namespace KellyControls
{
	partial class ColorGrid
	{
		...
		private void InitializeComponent()
		{
			...
			this.AddColorDialog = new SelectColorDlg.SelectColorDialog(this.components);
			this.SuspendLayout();
			// 
			// cmdEmptyColor
			// 
			...
			this.cmdEmptyColor.Image = global::KellyControls.Properties.Resources.not_small;
			...
			this.cmdAddColor.Image = global::KellyControls.Properties.Resources.add_small;
		...
		private SelectColorDlg.SelectColorDialog AddColorDialog;
	}
}
