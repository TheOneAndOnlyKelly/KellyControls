...
namespace KellyControls.CommonClasses
{
	public class Registry : IDisposable
	{
		...
		public const string REGISTRY_PATH = @"Software\{0}\Settings";
		public const string REGISTRY_ADDIN_PATH = @"Software\{0}\{1}\Settings";
		...
		private string DefaultKeyPath { get; set; } = string.Empty;
