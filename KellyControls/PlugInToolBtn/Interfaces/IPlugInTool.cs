...
using ScaledPoint = System.Drawing.Point;
...
namespace KellyControls.PlugInToolBtn.Interfaces
{
	public interface IPlugInTool : IDisposable
	{
		...
		/// <param name="scaledPoint">Point on the picture box (in scaled pixels) where the mouse event happened</param>
		/// <param name="actutalPoint">Point on the picture box (in Pixel) where the mouse event happened</param>
		void MouseClick(MouseButtons buttons, ScaledPoint scaledPoint, Point actutalPoint);
		...
		/// <param name="scaledPoint">Point on the picture box (in scaled pixels) where the mouse event happened</param>
		/// <param name="actutalPoint">Point on the picture box (in Pixel) where the mouse event happened</param>
		void MouseDoubleClick(MouseButtons buttons, ScaledPoint scaledPoint, Point actutalPoint);
		...
		/// <param name="scaledPoint">Point on the picture box (in scaled pixels) where the mouse event happened</param>
		/// <param name="actutalPoint">Point on the picture box (in Pixel) where the mouse event happened</param>
		void MouseDown(MouseButtons buttons, ScaledPoint scaledPoint, Point actutalPoint);
		...
		/// <param name="scaledPoint">Point on the picture box (in scaled pixels) where the mouse event happened</param>
		/// <param name="actutalPoint">Point on the picture box (in Pixel) where the mouse event happened</param>
		bool MouseMove(MouseButtons buttons, ScaledPoint scaledPoint, Point actutalPoint);
		...
		/// <param name="scaledPoint">Point on the picture box (in scaled pixels) where the mouse event happened</param>
		/// <param name="actutalPoint">Point on the picture box (in Pixel) where the mouse event happened</param>
		bool MouseUp(MouseButtons buttons, ScaledPoint scaledPoint, Point actutalPoint);
