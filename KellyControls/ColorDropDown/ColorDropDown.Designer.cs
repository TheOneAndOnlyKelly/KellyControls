namespace KellyControls
{
	partial class ColorDropDown
	{
		...
		private void InitializeComponent()
		{
			...
			this.cpnlDisplayColor = new KellyControls.ColorPanel();
			this.tabsColors = new System.Windows.Forms.TabControl();
			this.tabCustom = new System.Windows.Forms.TabPage();
			this.PaletteColorGrid = new KellyControls.ColorGrid();
			this.tabKnownColors = new System.Windows.Forms.TabPage();
			this.KnownColorsList = new KellyControls.ColorGrid();
			this.tabSystemColors = new System.Windows.Forms.TabPage();
			this.SystemColorsList = new KellyControls.ColorGrid();
			...
			this.KnownColorsList.Palette = KellyControls.ColorGrid.ColorPalette.KnownColors;
			...
			this.SystemColorsList.Palette = KellyControls.ColorGrid.ColorPalette.SystemColors;
			...
			// pctNoColor
			// 
			this.pctNoColor.Image = global::KellyControls.Properties.Resources.not_small;
