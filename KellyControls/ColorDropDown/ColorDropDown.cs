...
{
	[ToolboxItem(true)]
	[ToolboxBitmap(@"C:\Source\Repos\TheOneAndOnlyKelly\Utilities\KellyControls\ColorDropDown\ColorDropDown.bmp")]
	public partial class ColorDropDown : DropDownControl
	{
		...
		private Image _noColorImage = null;
		...
		/// </summary>
		[DefaultValue(typeof(bool), "True"), Description("Indicates whether the \"Add Colors\" button should show.")]
		...
		public Palette CustomColors
		{
			...
			set { this.PaletteColorGrid.CustomColors = value; }
		}
		...
		public override Font Font
		{
			...
			{
				base.Font = value;
				Font SubFont = new Font(value.FontFamily, value.SizeInPoints - 1f);
		...
		/// </summary>
		[DefaultValue(typeof(Size), "16, 16"), Description("Size of the color grid rectangles for lists.")]
		...
		public Image NoColorIndicatorImage
		{
			...
			set
			{
				...
				if (value == null)
				{
					pctNoColor.Image = global::KellyControls.Properties.Resources.not_small;
					pctNoColor.Size = new System.Drawing.Size(10, 10);
				}
				else
				{
		...
		/// </summary>
		[DefaultValue(typeof(byte), "4"), Description("Spacing between the color grid rectangles in the palette color grid.")]
		...
		/// </summary>
		[DefaultValue(typeof(Size), "16, 16"), Description("Size of the color grid rectangles in the palette color grid.")]
		...
		[DefaultValue(typeof(bool), "False"), Description("Display the color RGB values on the tooltip.")]
		...
		/// </summary>
		[DefaultValue(typeof(bool), "True"), Description("Indicates whether the SystemColors list should be show as a list, instead of a color grid.")]
		...
		private void cmdSelect_Click(object sender, EventArgs e)
		{
			...
			var frm = new SelectColorDlg.SelectColorForm(_color);
		...
		private void PaletteColorGrid_SelectedIndexChange(object sender, EventArgs e)
		{
			if (_isUpdating)
				return;
			this.Color = PaletteColorGrid.Color;
			this.CloseDropDown();
			OnColorChanged();
		}
		...
		private void SystemColorsList_SelectedIndexChange(object sender, EventArgs e)
		{
			if (_isUpdating)
				return;
			this.Color = SystemColorsList.Color;
			this.CloseDropDown();
			OnColorChanged();
		}
		...
		private void KnownColorsList_SelectedIndexChange(object sender, EventArgs e)
		{
			if (_isUpdating)
				return;
			this.Color = KnownColorsList.Color;
			this.CloseDropDown();
			OnColorChanged();
		}
